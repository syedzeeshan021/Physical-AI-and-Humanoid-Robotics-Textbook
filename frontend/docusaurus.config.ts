...
const config: Config = {
  ...
  tagline: 'Essentials textbook for AI and Robotics students',
  ...
  organizationName: 'syedzeeshan021', // Your GitHub org/user name.
  projectName: 'Physical-AI-and-Humanoid-Robotics-Textbook', // Your repo name.
